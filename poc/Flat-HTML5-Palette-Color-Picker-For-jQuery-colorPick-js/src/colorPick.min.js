...
!(function ($) {
  ($.fn.colorPick = function (config) {
    ...
    ($.colorPick = function (element, options) {
      ...
      dataInitialColor &&
        ((this.color = dataInitialColor), this.appendToStorage(this.color));
      var uniquePalette = [];
      return (
        $.each(
    ...
    ($.colorPick.prototype = {
      ...
      show: function (element, left, top) {
        $(".colorPickWrapper").remove(),
          ...
          !0 === $.fn.colorPick.defaults.allowCustomColor &&
            $("#colorPick").append(
              '<input type="text" style="margin-top:5px" class="customColorHash" />'
            ),
          !0 === $.fn.colorPick.defaults.allowRecent &&
            ($("#colorPick").append(
              ...
              : jQuery.each(
                  ...
                  function (index, item) {
                    if (
                      ...
                      index == $.fn.colorPick.defaults.recentMax - 1)
                    )
                      return !1;
                  }
                )),
